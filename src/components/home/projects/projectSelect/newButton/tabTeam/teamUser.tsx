...
import {setMoveNewTeam} from "../../../../../../redux/readucer/ProjectSlice";
...
function Teamuser(){
    ...
    if(branch==='0' || type==='0'){
        user=usermain.filter((UserNotPagging:UserNotPagging)=>!newteam.some(( UserNotPagging1: UserNotPagging)=>UserNotPagging1.id===UserNotPagging.id));
    } 
    if(branch==='1'){
